...
// Defaults are dynamically derived from the primary color using MD3 algorithm
const themeVars = computed(() => {
  // Convert globalPrimaryPreview (0-255) to 0-1 range for MD3 derivation
  const p = globalPrimaryPreview.value
  const livePrimary = [parseFloat((p[0] / 255).toFixed(3)), parseFloat((p[1] / 255).toFixed(3)), parseFloat((p[2] / 255).toFixed(3))]
  const [h, s, l] = rgbToHsl(livePrimary[0], livePrimary[1], livePrimary[2])
  const liveSecondary = hslToRgb(h, s * 0.5, Math.min(1, l + 0.12))
  const liveHover = hslToRgb(h, s, Math.min(1, l + 0.08))
  const livePressed = hslToRgb(h, s, Math.max(0, l - 0.08))
  const liveSurface = hslToRgb(h, s * 0.08, 0.05)
  const liveOnSurface = hslToRgb(h, s * 0.08, 0.92)
  const liveSurfaceVariant = hslToRgb(h, s * 0.1, 0.12)
  const liveOutline = hslToRgb(h, s * 0.15, 0.5)
  const liveDisabled = hslToRgb(h, s * 0.1, 0.9)

  const vars = {}
  const defaults = {
    '$cube_main_color': livePrimary,
    '$cube_button_main_default_color': livePrimary,
    '$cube_button_main_hover_color': liveHover,
    '$cube_button_main_pressed_color': livePressed,
    '$cube_button_main_locked_color': liveDisabled,
    ...
    '$cube_button_light_default_color': hslToRgb(h, s * 0.05, 0.8),
    '$cube_button_light_hover_color': hslToRgb(h, s * 0.05, 0.7),
    '$cube_button_light_pressed_color': hslToRgb(h, s * 0.05, 0.7),
    '$cube_button_light_locked_color': liveDisabled,
    '$cube_button_transparent_default_color': liveOnSurface,
    '$cube_button_transparent_hover_color': liveSecondary,
    '$cube_button_transparent_pressed_color': liveSecondary,
    '$cube_button_transparent_icon_default_color': liveOnSurface,
    '$cube_button_transparent_icon_hover_color': liveHover,
    '$cube_button_transparent_icon_pressed_color': livePressed,
    '$cube_button_text_color': liveOnSurface,
    '$cube_button_text_default_color': liveOnSurface,
    '$cube_button_text_hover_color': liveOnSurface,
    '$cube_button_text_pressed_color': liveOnSurface,
    '$cube_button_text_locked_color': liveDisabled,
    '$cube_button_secondary_text_default_color': hslToRgb(h, s * 0.05, 0.8),
    '$cube_button_secondary_text_hover_color': liveOnSurface,
    '$cube_button_secondary_text_pressed_color': liveOnSurface,
    '$cube_button_secondary_text_locked_color': liveDisabled,
    '$cube_button_glyph_default_color': liveOnSurface,
    '$cube_button_glyph_hover_color': liveOnSurface,
    '$cube_button_glyph_pressed_color': liveOnSurface,
    '$cube_button_glyph_locked_color': liveDisabled,
    '$cube_toggle_indicator_checked_color': livePrimary,
    '$cube_toggle_indicator_unchecked_color': livePrimary,
    '$cube_toggle_checked_hover_color': liveHover,
    '$cube_slider_progress_default_color': livePrimary,
    '$cube_slider_progress_hover_color': liveHover,
    '$cube_slider_button_default_color': liveOnSurface,
    '$cube_slider_background_color': liveSurface,
    '$cube_cell_color': hslToRgb(h, s * 0.05, 0.6),
    '$cube_cell_selected_color': liveSecondary,
    '$cube_cell_highlight_color': liveSecondary,
    '$cube_container_components_color': liveOnSurface,
    '$cube_container_components_full_color': livePrimary,
    '$cube_scroll_track_color': liveSurface,
    '$cube_scroll_box_color': hslToRgb(h, s * 0.1, 0.85),
    '$cube_progress_empty_color': liveSurface,
    '$cube_progress_full_color': liveDisabled,
    '$cube_dropdown_background_color': liveSurface,
    '$cube_radio_filled_color': liveOnSurface,
    '$cube_sidebar_bg_color': liveSurface,
    '$cube_tooltip_background_color': liveSurface,
    '$cube_underline_color': liveSurface,
    '$cube_divider_color': liveOutline,
    '$cube_dialog_background_color': liveSurface,
    '$cube_dialog_overlay_color': liveSurface,
    '$cube_dialog_title_text_color': liveOnSurface,
    '$cube_dialog_message_text_color': liveOnSurface,
    '$cube_toast_background_color': liveSurface,
    '$cube_corner_master_color': livePrimary,
    '$cube_red_dot_color': [1, 0, 0],
    '$cube_bar_color': livePrimary,
    '$cube_headbar_color': liveSurface,
    '$cube_headbar_title_color': liveOnSurface,
    '$cube_control_bg_color': liveSurface,
    '$cube_light_bg_color': liveSurfaceVariant,
    '$cube_text_color': liveOnSurface,
    '$cube_icon_color': liveOnSurface,
    '$cube_bg_color': liveSurface,
